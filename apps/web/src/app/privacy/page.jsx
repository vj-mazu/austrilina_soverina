...
export default function PrivacyPage() {
  return (
    <div className="bg-[#FAFAF5] min-h-screen">
      {/* Navigation */}
      <nav className="fixed top-0 w-full bg-[#1A1A1A] z-50 border-b border-[#D4A574]/20 shadow-xl">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="flex justify-between items-center h-16">
            <a href="/" className="flex items-center gap-3 group">
              <div className="w-10 h-10 bg-gradient-to-br from-[#D4A574] to-[#A67C52] rounded-lg flex items-center justify-center transform transition-all duration-500 group-hover:rotate-6">
                <Store className="w-5 h-5 text-white" />
              </div>
              <div>
                <h1 className="text-lg font-bold text-white font-cormorant tracking-wide">
            ...
            <div className="hidden md:flex items-center gap-8">
              {[
                ...
                <a
                  key={link.label}
                  href={link.href}
                  className="text-sm text-white/80 hover:text-[#D4A574] transition-colors duration-300 font-medium tracking-wide"
                >
                  {link.label}
                </a>
              ))}
              <a
                ...
                className="flex items-center gap-2 px-5 py-2 rounded-lg text-sm font-semibold transition-all duration-300 transform hover:-translate-y-0.5 bg-gradient-to-r from-[#D4A574] to-[#A67C52] text-white shadow-md hover:shadow-xl hover:shadow-[#D4A574]/30"
              >
